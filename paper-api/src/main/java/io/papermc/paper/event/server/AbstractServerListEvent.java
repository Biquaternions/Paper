...
/**
 * An abstract implementation of a server list event, handling shared logic.
 */
@ApiStatus.NonExtendable
public class AbstractServerListEvent extends ServerListPingEvent implements Cancellable {
    ...
    @ApiStatus.Internal
    public AbstractServerListEvent(final boolean async, @NotNull StatusClient client, @NotNull net.kyori.adventure.text.Component motd, int numPlayers,
    ...
    @ApiStatus.Internal
    protected final class PlayerIterator implements Iterator<Player> {
    ...
    @ApiStatus.Internal
    protected static final class UncheckedPlayerProfile implements PlayerProfile {
        private String name;
        private UUID uuid;
